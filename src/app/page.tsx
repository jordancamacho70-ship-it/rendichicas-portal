...
export default function RendichicasPortalDynamic() {
  ...
  const manuales: Manual[] = [
    { 
      ...
      videoUrl: "https://player.vimeo.com/video/ID_VIDEO_ESTACION", 
    ...
    { 
      ...
      videoUrl: "https://player.vimeo.com/video/1192095193", 
    ...
    { 
      id: 3, 
      codigo: "MOP-EST-VEN-002-R01", 
      titulo: "Uso del Dispensario", 
      cat: "Vendedor", 
      link: "/docs/MOP-EST-VEN-002-R01.pdf" 
    },
    { 
      id: 4, 
      codigo: "MOP-EST-VEN-005-R01", 
      titulo: "Servicio al Cliente", 
      cat: "Vendedor", 
      link: "/docs/Manual servicio al cliente.pdf" 
    },
    { 
      id: 5, 
      codigo: "MOP-EST-GER-001-R01", 
      titulo: "Conociendo tu Estación (Gerencia)", 
      cat: "Gerencia", 
      link: "/docs/MOP-EST-GER-001-R01.pdf" 
    },
    { 
      id: 6, 
      codigo: "MOP-EST-GER-002-R01", 
      titulo: "Inicio de Turno", 
      cat: "Gerencia", 
      link: "/docs/MOP-EST-GER-002-R01.pdf" 
    },
    { 
      id: 7, 
      codigo: "MOP-EST-GER-003-R01", 
      titulo: "Liquidación de Turno", 
      cat: "Gerencia", 
      link: "/docs/MOP-EST-GER-003-R01.pdf" 
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col text-gray-900">
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100 px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <button 
            onClick={() => { setAutorizado(false); setUsuario(""); setPassword(""); }} 
            className="px-4 py-2 bg-gray-100 text-gray-600 rounded-xl font-bold text-xs hover:bg-red-50 hover:text-red-500 transition-all"
          >
            <LogOut size={16} />
          </button>
                ...
                <div key={m.id} className={`bg-white rounded-[2rem] border shadow-sm p-4 flex flex-col group transition-all ${m.esPiloto ? 'border-[#E6007E]/30 ring-1 ring-[#E6007E]/10' : 'border-gray-100 hover:shadow-xl'}`}>
                  <div className="p-6 flex-1">
                    <div className="flex justify-between items-start mb-4">
                      <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase ${m.cat === 'Gerencia' ? 'bg-indigo-50 text-indigo-600' : 'bg-pink-50 text-[#E6007E]'}`}>
                        {m.cat}
                      </span>
                      {m.esPiloto && (
                        <span className="bg-[#E6007E] text-white text-[9px] px-2 py-0.5 rounded-full font-bold animate-pulse">
                          HUB MULTIMEDIA
                        </span>
                      )}
                    </div>
